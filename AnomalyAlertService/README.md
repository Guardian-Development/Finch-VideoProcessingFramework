...
This service provides a basis for sending alerts to a user based on a set of configured rules. It connects to Apache Kafka, and is then able to read the anomolous messages to decide which are worthy of notification.
